...
function ModuleItem({ module, checked, onChanged, onCategoryClick }
  ...
  return (
    <div className="form-check">
      ...
      <span className={`badge bg-${module.type === 'Major' ? 'primary' : 'secondary'}`} onClick={onCategoryClick} title={module.type + ' module'}>{module.category}</span>&nbsp;
...
export default function Home() {
  ...
  return (
    <main className="container">
      ...
      <p>Two <span className="badge bg-secondary">Minor</span> Modules count as one <span className="badge bg-primary">Major</span> Module.</p>
